...
export default function Alliances() {
  return (
    <section id="compromiso" className="bg-gray-50 pt-6 pb-12 scroll-mt-24">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <h2 className="text-2xl font-bold text-gray-900">Compromiso y Alianzas</h2>
      ...
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto px-6 lg:px-8">
        {items.map((item, i) => (
          <Flashcard key={i} title={item.title} description={item.description} image={item.image} />
        ))}
      </div>
    </section>
  )
