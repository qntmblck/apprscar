const clients = [
    ...
    { name: 'Fibox', logo: '/img/dashboard/fibox.png?v=2', width: 130, height: 60, offsetX: -15, offsetY: 1 },
    ...
    { name: 'Prisa', logo: '/img/dashboard/prisa.png?v=2', width: 185, height: 75, offsetX: 0, offsetY: -2 },
    { name: 'Canontex', logo: '/img/dashboard/canontex.png?v=2', width: 160, height: 70, offsetX: 0, offsetY: 2 },
    { name: 'Paris', logo: '/img/paris.png?v=2', width: 95, height: 40, offsetX: 15, offsetY: 20 },
    { name: 'Geoprospec', logo: '/img/dashboard/geo.png?v=2', width: 190, height: 70, offsetX: 35, offsetY: -4 },
    { name: 'Construmart', logo: '/img/contrumart.jpeg?v=2', width: 240, height: 83, offsetX: -15, offsetY: -10 },
    { name: 'Tecnopapel', logo: '/img/tecnopapel.png?v=2', width: 180, height: 76, offsetX: -40, offsetY: -4 },
  ]
