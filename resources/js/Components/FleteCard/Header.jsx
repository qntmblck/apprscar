...
export default function Header({
  ...
  return (
    <div className="w-full flex justify-between items-center mb-4">
      {/* Destino + Cliente: scroll horizontal sutil */}
      <div className="flex-1 flex space-x-6 overflow-x-auto whitespace-nowrap scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
