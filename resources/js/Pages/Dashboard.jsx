          ...
          <div className="p-6 sm:p-8 border-b border-gray-100">
            ...
            {!hasRole ? (
              <p className="mt-2 text-sm text-gray-700 max-w-3xl">
                Tu cuenta aún no tiene un rol asignado. Puedes <b>postular como conductor</b> o
                <b> solicitar un servicio de transporte</b>. Si ya perteneces a SCAR y necesitas acceso,
                contáctanos.
              </p>
            ) : (
            ...
            <div className="p-6 sm:p-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <section className="rounded-xl border border-gray-200">
                ...
                >
                  ...
                  {/* Upload CV (estilo template, pero legible) */}
                  <div>
