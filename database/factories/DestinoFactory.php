...
class DestinoFactory extends Factory
{
    ...
    protected static array $presets = [
        ...
        // ————— Destinos añadidos para coincidir con TarifaFactory —————
        ['nombre' => 'LONGAVI',                 'region' => 'Maule',                 'km' => 301],
        ['nombre' => 'LOS ANGELES',             'region' => 'Biobío',                'km' => 495],
        ['nombre' => 'PUCON',                   'region' => 'La Araucanía',          'km' => 766],
        ['nombre' => 'QUELLON',                 'region' => 'Los Lagos',             'km' => 1266],
        ['nombre' => 'VALPARAISO',              'region' => 'Valparaíso',            'km' => 140],
    ];

    /**
     * Número exacto de presets disponibles.
     */
    public const PRESET_COUNT = 105;
